  ...
  return (
    <div className="flex flex-col">
      <Topbar
        ...
        help={[
          { title: "Klientët tuaja", body: "Këtu shfaqen vetëm klientët që ju janë caktuar. Klikoni mbi çdo rresht për të hapur detajet e plota — informacionin e debitorit, historikun e pagesave dhe veprimet e ndërmarra." },
          { title: "Si të regjistroni një telefonatë ose pagesë", body: "Klikoni mbi një klient për ta hapur, pastaj përdorni butonat e veprimit në të djathtën e sipërme — 'Regjistro Aktivitet' për telefonata dhe vizita, 'Regjistro Pagesën' kur është marrë para." },
        ]}
      />
      ...
      <div className="p-4 md:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <KpiCard label="Klientët e Mia" value={loading ? "—" : fmtNum(cases.length)} href="/cases" />
          ...
          <div className="md:col-span-2">
            <Card padding="none">
              <div className="px-5 pt-4 pb-3 border-b border-gray-100 flex items-center justify-between">
                <div>
                  <h3 className="text-[13px] font-semibold text-gray-900">Klientët e Mia</h3>
                  <p className="text-[12px] text-gray-400">Klientët e caktuara tek ju</p>
                </div>
              ...
              {loading ? <Spinner /> : cases.length === 0 ? (
                <div className="px-5 py-10 text-center text-[13px] text-gray-400">Nuk ka klient të caktuara tek ju akoma</div>
              ) : (
          ...
          <div className="flex flex-col gap-4">
            <Card>
              ...
              <div className="space-y-1">
                {[
                  { label: "Klientët e mia", href: "/cases", icon: FolderOpen },
  ...
  return (
    <div className="flex flex-col">
      <Topbar title="Ballina" subtitle={subtitle} help={[
        { title: "Shifrat kryesore", body: "Këto tregojnë të dhënat më të rëndësishme të portofolit tuaj — gjendja debitore totale, shuma e arkëtuar këtë muaj, numri i klientëve aktive dhe debitorët që premtuan pagesë sot. Klikoni çdo shifër për të parë listën e plotë." },
      ...
      <div className="p-4 md:p-6 space-y-5">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    { step: "3", label: "Importo Klientët e Kredive", desc: "Përdorni importin masiv në Raporte për të ngarkuar portofolio fillestar.", href: "/reports" },
                  ].map((s) => (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-2 md:gap-3">
          {loading || !stats ? Array.from({ length: 6 }).map((_, i) => (
            ...
            { label: "Klient Aktive", value: stats.activeCases.toLocaleString(), href: "/cases" },
            ...
            { label: "Klient Juridike", value: stats.legalCases.toLocaleString(), href: "/legal" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 md:items-stretch">
          ...
          <div className="flex flex-col gap-4 h-full">
            <Card className="p-4 md:p-5">
              ...
              <div className="space-y-1.5">
                {loading || !stats ? Array.from({ length: 5 }).map((_, i) => (
                  ...
                  { icon: Scale,        label: "Klient juridike",           val: stats.legalCases,          href: "/legal" },
                  { icon: FolderOpen,   label: "Klient aktive",             val: stats.activeCases,         href: "/cases" },
            ...
            <Card className="flex-1 flex flex-col p-4 md:p-5">
              <CardHeader title="Sipas Zyrës" subtitle="Klient aktive" />
  ...
  return (
    <div className="flex flex-col">
      <Topbar title="Ballina" subtitle={`Pasqyrë e portofolit · ${MONTHS[now.getMonth()]} ${now.getFullYear()}`} help={[
        ...
        { title: "Shifrat kryesore", body: "Këto tregojnë gjendjen aktuale të portofolit — gjendja debitore totale, para të arkëtuara këtë muaj, klientët e hapura dhe klientët në procedim juridik. Klikoni çdo shifër për të parë listën e plotë pas saj." },
      ]} />
      <div className="p-4 md:p-6 space-y-5">
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-2 md:gap-3">
          {loading || !stats ? Array.from({ length: 6 }).map((_, i) => (
            ...
            { label: "Klient Aktive",             value: stats.activeCases.toLocaleString(),        sub: "Aktualisht aktive",          href: "/cases" },
            ...
            { label: "Klient Juridike",           value: stats.legalCases.toLocaleString(),         sub: "Në procedim",                href: "/legal" },
          ].map((k) => <KpiCard key={k.label} {...k} />)}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:items-stretch">
          ...
          <div className="flex flex-col gap-4 h-full">
            ...
            <Card>
              ...
              <div className="space-y-1">
                {[
                  { label: "Klientët", href: "/cases", icon: FolderOpen },
