    ...
    <div className="flex flex-col">
      ...
      <div className="p-4 md:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {(activeTab === "officers" ? [
            { label: isOfficer ? "Dosjet Aktive Tuaja" : "Oficerë të Gjurmuar", value: isOfficer ? (officers[0]?.activeCases ?? 0) : officers.length },
            ...
            { label: "Dosje Aktive", value: institutionStats.reduce((s, i) => s + i.activeCases, 0).toLocaleString() },
          ]).map((s) => (
