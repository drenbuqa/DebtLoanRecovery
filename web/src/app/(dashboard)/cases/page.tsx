...
function DeleteCaseModal({ caseId, onClose, onDeleted }: { caseId: string; onClose: () => void; onDeleted: () => void }) {
  ...
  React.useEffect(() => {
    (casesApi as any).deletePreview(caseId)
      ...
      .catch(() => setError("Nuk mund të lexohen të dhënat e klientit."))
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-[14px] font-semibold text-gray-900">Fshi Klientin</span>
          </div>
              ...
              {preview.hasPayments && (
                <div className="flex items-start gap-2.5 bg-amber-50 border border-amber-200 rounded-xl p-3.5">
                  ...
                  <p className="text-[12px] text-amber-800 leading-relaxed">
                    Kjo klient ka <strong>{preview.counts.payments} pagesë</strong> të regjistruar. Pagesat gjithashtu do të fshihen.
                  </p>
                </div>
              )}
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-100">
          ...
          >
            ...
            {deleting ? "Duke fshirë..." : "Fshi Klientin"}
          </button>
        </div>
      </div>
    </div>
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Kërko debitor, klient…"
                value={searchInput}
          ...
          {error ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-200 flex flex-col items-center justify-center py-16 gap-4">
              ...
              <div className="text-center">
                <div className="text-[13px] font-semibold text-gray-700 mb-1">Nuk u gjetën klient</div>
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              ...
              placeholder="Kërko debitor, ref. klient, kredi…"
              value={searchInput}
              onChange={(e) => setSearchInput(e.target.value)}
            />
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
          {error ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 px-6 text-center gap-4">
              ...
              <div>
                <div className="text-[13px] font-semibold text-gray-700 mb-1">Nuk u gjetën klient</div>
                <div className="text-[12px] text-gray-400 max-w-xs">Provoni të ndryshoni filtrat ose krijoni një klient të re për të filluar.</div>
              </div>
            </div>
          ) : (
